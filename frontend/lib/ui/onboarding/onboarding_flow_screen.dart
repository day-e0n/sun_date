...
class _OnboardingFlowScreenState extends State<OnboardingFlowScreen> {
  ...
  final _nicknameService = RandomNicknameService();
  ...
  // Step 3: Gender
  String _gender = 'female'; // Use String instead of Gender enum
  ...
  // Step 5: Region
  final Map<String, List<String>> _regions = kRegions;
  late String _selectedProvince;
  late String _selectedCity;
  
  // (Not used in pageview yet) For volunteer categories
    ...
    try {
      ...
      final profileResp = await http.put(
        ...
        body: jsonEncode({
          ...
          "age": 20, // TODO: 실제 나이 입력받기
          "sex": _gender,
          "mbti": _selectedMbti,
          "location": "$_selectedProvince $_selectedCity",
          "volunteer_field": _selectedCategories.isNotEmpty ? _categoryToServerString(_selectedCategories.first) : null
        }),
      );
  ...
  String _categoryToServerString(VolunteerCategory c) {
    switch (c) {
      case VolunteerCategory.animal: return "동물";
      case VolunteerCategory.nursingHome: return "시설";
      case VolunteerCategory.environment: return "환경";
      case VolunteerCategory.education: return "교육";
      default: return "기타";
    }
  }
}
